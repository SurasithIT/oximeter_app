  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text("Last connected"),
        RaisedButton(
          onPressed: () => bluetoothHelperService.connectLastedDevice(),
          child: Text("Connecttt"),
        ),
                  ...
                  children: snapshot.data!
                      ...
                      .map((e) => Column(
                            children: [
                              ...
                              RaisedButton(
                                  onPressed: () => bluetoothHelperService
        ...
        StreamBuilder<List<BluetoothDevice>>(
            stream:
                bluetoothHelperService.flutterBlue.connectedDevices.asStream(),
    ...
    return Column(
      children: [
        ...
        StreamBuilder<Map<String, dynamic>>(
            ...
            initialData: {'spO2': 0, 'pulseRate': 0, 'pi': 0.0},
            builder: (context, snapshot) {
              VoidCallback onPressed;
              onPressed = () => {print("Connect")};
              return Text(
                  "SpO2 ${snapshot.data?["spO2"]}, PulseRate ${snapshot.data?["pulseRate"]}, PI ${snapshot.data?["pi"]}");
            }),
      ],
    );
  }
